  ...
  return (
    <EditableSiteShell>
      <main className="bg-[#f7f4ef] text-[#111]">
        <section className="border-b border-black/10 bg-[var(--slot4-accent)] text-white">
          <div className="mx-auto max-w-[var(--editable-container)] px-4 py-16 sm:px-6 lg:px-8 lg:py-24">
            ...
            <h1 className="mt-5 max-w-5xl text-5xl font-black leading-[0.92] tracking-[-0.055em] sm:text-7xl">
          ...
          <aside className="grid bg-[#f7f4ef]">
            {pagesContent.about.values.map((value, index) => (
              <div key={value.title} className="border-b border-black p-7 last:border-b-0 sm:p-9">
                ...
                <h2 className="mt-4 text-3xl font-black leading-tight tracking-[-.04em]">{value.title}</h2>
        ...
        <section className="border-y border-black bg-[#171717] text-white">
          <div className="mx-auto flex max-w-[var(--editable-container)] flex-col gap-6 px-4 py-12 sm:px-6 lg:flex-row lg:items-center lg:justify-between lg:px-8">
            <h2 className="max-w-3xl text-4xl font-black leading-none tracking-[-.04em] sm:text-5xl">Explore campaigns shaping digital visibility.</h2>
            <Link href="/media-distribution" className="inline-flex w-fit bg-[var(--slot4-accent)] px-6 py-4 text-xs font-black uppercase tracking-[0.18em]">Explore campaigns</Link>
          </div>
        </section>
      </main>
    </EditableSiteShell>
